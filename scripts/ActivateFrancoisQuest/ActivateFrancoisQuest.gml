...
function ActivateFrancoisQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? francois_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? francois_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? francois_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("My name's Francois.");
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? francois_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? francois_obj] = 3;
			}
			else
			{
				//clue reminder
