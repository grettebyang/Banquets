...
function ActivateGiuseppeQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? giuseppe_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? giuseppe_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? giuseppe_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("Hi. My name's Giuseppe.");
				NewTextBox("I would like some " + foodName, 0);
				global.questStatus[? giuseppe_obj] = 1;
			}
		}break;
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? giuseppe_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? giuseppe_obj] = 3;
			}
			else
			{
				//clue reminder
		...
		case 3: //linen quest already started
		{
			...
			{
				//clue reminder
				NewTextBox("I can't let the other humans see me.\nUs dogs aren't allowed here.\nWhat I need is something that will cover me up.", 0);
			}			
		} break;
