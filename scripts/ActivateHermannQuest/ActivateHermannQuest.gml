...
function ActivateHermannQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? hermann_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? hermann_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? hermann_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("I'm Hermann.");
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? hermann_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? hermann_obj] = 3;
			}
			else
			{
				//clue reminder
