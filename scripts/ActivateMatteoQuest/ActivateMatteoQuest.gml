...
function ActivateMatteoQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? matteo_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? matteo_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? matteo_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("I'm Matteo.");
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? matteo_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? matteo_obj] = 3;
			}
			else
			{
				//clue reminder
