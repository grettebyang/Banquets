...
function ActivateGiovanniQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? giovanni_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? giovanni_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? giovanni_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("I'm Giovanni.");
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? giovanni_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? giovanni_obj] = 3;
			}
			else
			{
				//clue reminder
