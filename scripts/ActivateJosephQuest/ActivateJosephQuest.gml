...
function ActivateJosephQuest(foodName, npcName, giveFood, giveLinen){
	...
	switch (global.questStatus[? joseph_obj])
	{
		case 0: //not started
		{
			...
			if(giveFood)
			{
				...
				global.questStatus[? joseph_obj] = 2;
			...
			else if (hasFood)
			{
				...
				global.questStatus[? joseph_obj] = 1;
			
			}
			else
			{
				//offer quest
				NewTextBox("I'm Joseph.");
		...
		case 2: // dog introduces linen quest
		{
			if(giveLinen)
			{
				...
				global.questStatus[? joseph_obj] = 4;
			...
			else if (hasLinen)
			{
				...
				global.questStatus[? joseph_obj] = 3;
			}
			else
			{
				//clue reminder
