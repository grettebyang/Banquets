...
if(instance_exists(player_obj))
{
	...
	if(tableFluff > -1)
	{
		draw_sprite(FluffSpriteArray[rotateIndex], tableFluff, x, y);
	}
}

//Draw the finished animation
if(steamed && doneIndex < sprite_get_number(DoneSpriteArray[rotateIndex]))
{
	draw_sprite(DoneSpriteArray[rotateIndex], doneIndex, x, y);
	doneIndex += sprite_get_speed(DoneSpriteArray[rotateIndex])/FRAME_RATE;
}
